...
import { fetchAccountReceivable, fetchBankBalances } from "../features/dataSlice";
    ...
    <div>
      <Navbar bg="dark" variant="dark" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="/" className="nav-link"><i className="bi bi-house"></i> Home</Nav.Link>
      ...
      <Modal show={showReadOnlyModal} onHide={handleCloseReadOnly}>
        ...
        <Modal.Body>
          {currentRow && (
            <div>
              <p><strong>Invoice Date:</strong> {currentRow.invoice_date}</p>
              <p><strong>Invoice Number:</strong> {currentRow.invoice_number}</p>
              <p><strong>Customer Name:</strong> {currentRow.customer_name}</p>
              <p><strong>Total Amount:</strong> {currentRow.total_amount}</p>
              <p><strong>Due Date:</strong> {currentRow.due_date}</p>
              <p><strong>Balance:</strong> {currentRow.balance}</p>
              <p><strong>Service Type:</strong> {currentRow.service_type}</p>
            </div>
          )}
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={handleCloseReadOnly}>Close</Button>
